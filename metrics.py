"""
Edge Computing Performance Metrics Collector & Reporter
========================================================
Tracks inference timing, system resources, throughput, latency,
and edge-specific efficiency metrics for the YOLOv5 line-crossing counter.

Metrics collected
-----------------
Inference      : preprocess / forward-pass / postprocess / total (ms)
Throughput     : display FPS, inference FPS, frame drop rate
Latency        : end-to-end (frame submit → result ready), P50, P95, jitter
Detection      : avg detections/frame, avg confidence, detection rate
Crossing       : IN / OUT event counts
System (psutil): CPU%, RAM MB/%, CPU temperature, per-process CPU & RAM
Edge efficiency: inference ms per core, frames/minute, throughput efficiency
"""
